...
public class ColaboradorAfastamentoDaoHibernateTest extends GenericDaoHibernateTest<ColaboradorAfastamento>
{
	...
	public void testFindAllSelect()
	{
		...
		Collection<ColaboradorAfastamento> teste = colaboradorAfastamentoDao.findAllSelect(0, 0, empresa.getId(), afastamento.getId(), "a", estabelecimentoIds, DateUtil.criarDataMesAno(1, 3, 2009), DateUtil.criarDataMesAno(1, 6, 2009), "DESC", false, afastadoPeloINSS);
		assertEquals(1, teste.size());

		Collection<ColaboradorAfastamento> teste2 = colaboradorAfastamentoDao.findAllSelect(1, 15, empresa.getId(), null, "", estabelecimentoIds, null, null, "DESC", false, afastadoPeloINSS);
		...
		afastamentoDao.save(afastamento);
		Collection<ColaboradorAfastamento> teste3 = colaboradorAfastamentoDao.findAllSelect(1, 15, empresa.getId(), null, "", estabelecimentoIds, null, null, "DESC", false, afastadoPeloINSS);
		...
		afastamentoDao.save(afastamento);
		Collection<ColaboradorAfastamento> teste4 = colaboradorAfastamentoDao.findAllSelect(1, 15, empresa.getId(), null, "", estabelecimentoIds, null, null, "DESC", false, afastadoPeloINSS);
