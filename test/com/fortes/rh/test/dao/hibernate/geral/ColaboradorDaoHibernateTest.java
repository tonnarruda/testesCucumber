...
//		colaborador2.setDataDesligamento(null);
	...
	public void testFindColaboradoresByCodigoAC() 
	{
		...
		assertEquals(1, colaboradorDao.findColaboradoresByCodigoAC(empresa1, "000012").size());
		...
		assertEquals(2, colaboradorDao.findColaboradoresByCodigoAC(empresa1, new String[]{"000012","000013","000014"}).size());
	}
