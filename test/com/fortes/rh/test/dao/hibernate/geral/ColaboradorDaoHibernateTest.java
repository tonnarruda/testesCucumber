...
//	}
	...
	public void testFindAreaOrganizacionalByGruposOrAreas()
	{
		...
		Collection<Colaborador> colaboradors = colaboradorDao.findAreaOrganizacionalByAreas(estabelecimentoIds, areaOrganizacionalIds, null, false);
	...
	public void testFindAreaOrganizacionalByGruposOrAreasCamposExtras()
	{
		...
		Collection<Colaborador> colaboradors = colaboradorDao.findAreaOrganizacionalByAreas(estabelecimentoIds, areaOrganizacionalIds, camposExtras, true);
		assertEquals(1, colaboradors.size());
		...
		colaboradors = colaboradorDao.findAreaOrganizacionalByAreas(estabelecimentoIds, areaOrganizacionalIds, camposExtrasBusca, true);
		assertEquals(1, colaboradors.size());
