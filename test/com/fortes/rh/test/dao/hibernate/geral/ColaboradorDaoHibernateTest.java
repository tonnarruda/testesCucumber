...
//		colaborador2.setDataDesligamento(null);
	...
	public void testFindAdmitidosHaDiasPeriodoExperiencia() 
	{
		...
		colabPeriodoExperienciaAvaliacaoJoseAvaliado.setTipo(ColaboradorPeriodoExperienciaAvaliacao.TIPO_GESTOR);
		...
		colabPeriodoExperienciaAvaliacaoJoseAvaliado2.setTipo(ColaboradorPeriodoExperienciaAvaliacao.TIPO_COLABORADOR);
		...
		colabPeriodoExperienciaAvaliacaoMariaJaRespondido.setTipo(ColaboradorPeriodoExperienciaAvaliacao.TIPO_GESTOR);
		...
		colabDesligadoPeriodoExperienciaAvaliacao.setTipo(ColaboradorPeriodoExperienciaAvaliacao.TIPO_COLABORADOR);
		colaboradorPeriodoExperienciaAvaliacaoDao.save(colabDesligadoPeriodoExperienciaAvaliacao);
		
		ColaboradorQuestionario colaboradorQuestionarioJoseAvaliado = ColaboradorQuestionarioFactory.getEntity();
		colaboradorQuestionarioJoseAvaliado.setColaborador(joseAvaliado);
		colaboradorQuestionarioJoseAvaliado.setAvaliacao(avaliacao);
		colaboradorQuestionarioDao.save(colaboradorQuestionarioJoseAvaliado);
		
		ColaboradorQuestionario colaboradorQuestionarioMariaAvDesempenho = ColaboradorQuestionarioFactory.getEntity();
		colaboradorQuestionarioMariaAvDesempenho.setColaborador(mariaJaRespondido);
		colaboradorQuestionarioMariaAvDesempenho.setAvaliacao(avaliacao);
		colaboradorQuestionarioMariaAvDesempenho.setAvaliacaoDesempenho(avaliacaoDesempenho);
		colaboradorQuestionarioDao.save(colaboradorQuestionarioMariaAvDesempenho);
	...
	public void testCountProvidencia() 
	{
		...
		assertEquals(2, colaboradorDao.countProvidencia(hoje, dataFim, Arrays.asList(empresa.getId()),  new Long[]{estabelecimento.getId()}, null, null, 2).size());
		assertEquals(2, colaboradorDao.countProvidencia(hoje, dataFim, Arrays.asList(empresa.getId()),  null, null, null, 2).size());
	}
	...
	public void testCountDemitidosTempoServico()
	{
		...
		criarColaboradorHistorico(null, null, empresa, DateUtil.criarDataMesAno(1, 2, 2010), DateUtil.criarDataMesAno(1, 3, 2012), null, null, null, estabelecimento, a1, fs1, null, null);
		criarColaboradorHistorico(null, null, empresa, DateUtil.criarDataMesAno(1, 2, 2010), DateUtil.criarDataMesAno(1, 8, 2010), null, null, null, estabelecimento, a1, fs1, null, null);
		criarColaboradorHistorico(null, null, empresa, DateUtil.criarDataMesAno(1, 5, 2011), DateUtil.criarDataMesAno(1, 11, 2011), null, null, null, estabelecimento, a1, fs1, null, null);
		criarColaboradorHistorico(null, null, empresa, DateUtil.criarDataMesAno(1, 5, 2009), DateUtil.criarDataMesAno(1, 11, 2009), null, null, null, estabelecimento1, a1, fs1, null, null);
		...
		criarColaboradorHistorico(null, null, empresaTurnover, DateUtil.criarDataMesAno(1, 5, 2011), DateUtil.criarDataMesAno(1, 11, 2011), null, null, null, estabelecimento, a1, fs1, can1, null);
