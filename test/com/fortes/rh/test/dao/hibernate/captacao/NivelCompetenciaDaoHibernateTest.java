...
public class NivelCompetenciaDaoHibernateTest extends GenericDaoHibernateTest<NivelCompetencia>
{
	...
	public void testDeleteByConfiguracaoNivelCompetenciaColaborador()
	{
		...
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia = ConfiguracaoNivelCompetenciaFactory.getEntity(nivel, habilidade.getId(), null, configuracaoNivelCompetenciaColaborador, null, null);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia);
	...
	public void testDeleteByConfiguracaoNivelCompetenciaFaixaSalarial()
	{
		...
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia = ConfiguracaoNivelCompetenciaFactory.getEntity(nivel, habilidade.getId(), null, null, configuracaoNivelCompetenciaFaixaSalarial, null);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia);
	...
	public void testRemoveColaborador(){
		...
		NivelCompetencia nivel = NivelCompetenciaFactory.getEntity(1L, "Nivel 1", empresa1);
		nivelCompetenciaDao.save(nivel);
		...
		ConfiguracaoNivelCompetenciaFaixaSalarial cncFaixaSalarial1  = ConfiguracaoNivelCompetenciaFaixaSalarialFactory.getEntity(faixaSalarial, new Date());
		configuracaoNivelCompetenciaFaixaSalarialDao.save(cncFaixaSalarial1);

		ConfiguracaoNivelCompetenciaColaborador cncColaborador1 = ConfiguracaoNivelCompetenciaColaboradorFactory.getEntity(colaborador, cncFaixaSalarial1);
		configuracaoNivelCompetenciaColaboradorDao.save(cncColaborador1);
		
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia1 = ConfiguracaoNivelCompetenciaFactory.getEntity(nivel, habilidade.getId(), null, cncColaborador1, null, null);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia1);

		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia2 = ConfiguracaoNivelCompetenciaFactory.getEntity(nivel, habilidade.getId(), null, cncColaborador1, null, null);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia2);
		
		ConfiguracaoNivelCompetenciaColaborador cncColaborador2 = ConfiguracaoNivelCompetenciaColaboradorFactory.getEntity(colaborador, cncFaixaSalarial1);
		configuracaoNivelCompetenciaColaboradorDao.save(cncColaborador2);
		
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia3 = ConfiguracaoNivelCompetenciaFactory.getEntity(nivel, habilidade.getId(), null, cncColaborador2, null, null);
		...
		Collection<ConfiguracaoNivelCompetencia> configs = configuracaoNivelCompetenciaDao.findByConfiguracaoNivelCompetenciaColaborador(null, cncColaborador2.getId(), cncFaixaSalarial1.getId());
		assertEquals(0, configs.size());

		configs = configuracaoNivelCompetenciaDao.findByConfiguracaoNivelCompetenciaColaborador(null, cncColaborador1.getId(), cncFaixaSalarial1.getId());
		assertEquals(0, configs.size());
	}
	...
	public void testRemoveByConfiguracaoNivelCompetenciaColaborador(){
		...
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia = ConfiguracaoNivelCompetenciaFactory.getEntity(nivelCompetencia, habilidade.getId(), null, configNivelCompetenciaColaborador1, null, null);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia);
	...
	public void testRemoveDependenciasComConfiguracaoNivelCompetenciaColaboradorByFaixaSalarial()
	{
		...
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia1 = ConfiguracaoNivelCompetenciaFactory.getEntity(nivelCompetencia, habilidade.getId(), null, configNivelCompetenciaColaborador1, null, null);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia1);
		...
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia2 = ConfiguracaoNivelCompetenciaFactory.getEntity(nivelCompetencia, habilidade.getId(), null, configNivelCompetenciaColaborador2, null, null);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia2);	
	...
	public void testRemoveDependenciasComConfiguracaoNivelCompetenciaFaixaSalarialByFaixaSalarial()
	{
		...
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia1 = ConfiguracaoNivelCompetenciaFactory.getEntity(nivelCompetencia, habilidade.getId(), null, null, configuracaoNivelCompetenciaFaixaSalarial1, null);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia1);
		...
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia2 = ConfiguracaoNivelCompetenciaFactory.getEntity(nivelCompetencia, habilidade.getId(), null, null, configuracaoNivelCompetenciaFaixaSalarial2, null);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia2);
	...
	public void testFindByConfiguracaoNivelCompetenciaColaborador(){
		Conhecimento conhecimento = ConhecimentoFactory.getConhecimento("Conhecimento");
		conhecimentoDao.save(conhecimento);
		
		Atitude atitude = AtitudeFactory.getEntity("Atitude");
		atitudeDao.save(atitude);
	...
	public void testFindCompetenciaBySolicitacaoIdCandidatoIdAndDataNivelCompetenciaHistorico(){
		...
		ConfiguracaoNivelCompetenciaFaixaSalarial cncFaixaSalarial = ConfiguracaoNivelCompetenciaFaixaSalarialFactory.getEntity(faixaSalarial, new Date(), nivelCompetenciaHistorico1);
		configuracaoNivelCompetenciaFaixaSalarialDao.save(cncFaixaSalarial);
		...
		ConfigHistoricoNivel configHistoricoNivel = ConfigHistoricoNivelFactory.getEntity(1L, 5, nivelCompetenciaHistorico2, nivelCompetencia1, null);
		configHistoricoNivelDao.save(configHistoricoNivel);
		
		ConfiguracaoNivelCompetenciaCandidato cncCandidato = ConfiguracaoNivelCompetenciaCandidatoFactory.getEntity(jose, solicitacao, cncFaixaSalarial, new Date());
		configuracaoNivelCompetenciaCandidatoDao.save(cncCandidato);
		
		ConfiguracaoNivelCompetencia configuracaoNivelCompetencia1 = ConfiguracaoNivelCompetenciaFactory.getEntityCandidato(cncCandidato, faixaSalarial, nivelCompetencia1, conhecimento.getId(), TipoCompetencia.CONHECIMENTO);
		configuracaoNivelCompetenciaDao.save(configuracaoNivelCompetencia1);
	
		Collection<ConfiguracaoNivelCompetencia> configs = configuracaoNivelCompetenciaDao.findConfiguracaoNivelCompetenciaCandidato(cncCandidato.getId());
		assertEquals(1, configs.size());
	...
	//TODO Não funfa
	public void testFindByAvaliacaaDesempenhoAndAvaliado(){
		Empresa empresa = EmpresaFactory.getEmpresa();
		empresaDao.save(empresa);
		...
		Colaborador avaliado = ColaboradorFactory.getEntity(1L, "avaliado", "", "0123", null, null, empresa);
		colaboradorManager.save(avaliado);

		Colaborador avaliador = ColaboradorFactory.getEntity(2L, "avaliador", "", "0124", null, null, empresa);
		colaboradorManager.save(avaliador);

		HistoricoColaborador historicoAvaliador = HistoricoColaboradorFactory.getEntity(avaliador, faixaSalarial, DateUtil.criarDataMesAno(1, 1, 2000), StatusRetornoAC.CONFIRMADO);
		historicoColaboradorDao.save(historicoAvaliador);
		
		AvaliacaoDesempenho avaliacaoDesempenho = AvaliacaoDesempenhoFactory.getEntity("Titulo Avaliação Desempenho");
		avaliacaoDesempenhoDao.save(avaliacaoDesempenho);
		
		ColaboradorQuestionario colaboradorQuestionario = ColaboradorQuestionarioFactory.getEntity(avaliado, avaliador, null, avaliacaoDesempenho, true);
		colaboradorQuestionarioDao.save(colaboradorQuestionario);
		
		ConfiguracaoNivelCompetenciaColaborador configColaborador = criaConfiguracaoNivelCompetenciaColaborador(faixaSalarial, avaliado, DateUtil.criarDataMesAno(17, 8, 2011), avaliador, colaboradorQuestionario, configuracaoNivelCompetenciaFaixaSalarial);
		configuracaoNivelCompetenciaColaboradorDao.save(configColaborador);
		
		ConfiguracaoNivelCompetencia cnc = ConfiguracaoNivelCompetenciaFactory.getEntityColaborador(null, configColaborador, nivelCompetencia,  atitude.getId(), atitude.getNome(), TipoCompetencia.ATITUDE);
		configuracaoNivelCompetenciaDao.save(cnc);
	...
	public void testFindNiveisCompetenciaByAvDesempenho()
	{
		Empresa empresa = EmpresaFactory.getEmpresa();
		empresaDao.save(empresa);
		...
		ConfiguracaoNivelCompetenciaColaborador configuracaoNivelCompetenciaColaborador = ConfiguracaoNivelCompetenciaColaboradorFactory.getEntity(null, configuracaoNivelCompetenciaFaixaSalarial);
		configuracaoNivelCompetenciaColaborador.setColaboradorQuestionario(colaboradorQuestionario);
		configuracaoNivelCompetenciaColaboradorDao.save(configuracaoNivelCompetenciaColaborador);
