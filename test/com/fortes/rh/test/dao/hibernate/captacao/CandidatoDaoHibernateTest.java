...
//		assertEquals(StringUtil.encodeString("123456"), candidatoRetorno.getSenha());
	...
	public void testFindCandidatosForSolicitacaoAllEmpresas()
	{
		...
		Collection<Candidato> resultados = candidatoDao.findCandidatosForSolicitacaoAllEmpresas(indicadoPor, nomeBusca, cpfBusca, estado.getId(), cidade.getId(), cargosCheck, conhecimentosCheck, null, false);
		assertEquals(1, resultados.size());
	}
	...
	public void testFindCandidatosForSolicitacaoByEmpresa()
	{
		...
		Collection<Candidato> resultados = candidatoDao.findCandidatosForSolicitacaoByEmpresa(empresa.getId(),indicadoPor, nomeBusca, cpfBusca, estado.getId(), cidade.getId(), cargosIds, conhecimentosIds, null, false);
		assertEquals(1, resultados.size());
	}
	...
	public void testFindCandidatosForSolicitacaoByEmpresaSomenteCandidatosSemSolicitacao()
	{
		...
		Collection<Candidato> resultados = candidatoDao.findCandidatosForSolicitacaoByEmpresa(empresa.getId(), null, null, null, null, null, null, null, null, somenteCandidatosSemSolicitacao); 
		assertEquals(2, resultados.size());
	...
	public void testFindCandidatosForSolicitacaoByEmpresaCandidatoJaSelecionado()
	{
		...
		Collection<Candidato> resultados = candidatoDao.findCandidatosForSolicitacaoByEmpresa(empresa.getId(), "", nomeBusca, cpfBusca, null, null, null, null, candidatosJaSelecionados, false);
		assertEquals(1, resultados.size());
	}
