...
public class UserDetailsImplTest extends TestCase
{
	public void testUserDetailsImpl()
	{
		...
		UserDetailsImpl userDetailsImpl = new UserDetailsImpl(id, "nome", "username", "1234", false, new Date(), null, false, false, false, false, "menu", empresa, colaborador, null, null);
