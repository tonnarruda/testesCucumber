...
public class TurmaEditActionTest extends MockObjectTestCase
{
    ...
    public void testPrepareUpdate() throws Exception
    {
    	...
    	diaTurmaManager.expects(once()).method("montaListaDias").with(eq(turma.getDataPrevIni()), ANYTHING).will(returnValue(new ArrayList<CheckBox>()));
    ...
    public void testPreparePresenca() throws Exception
    {
    	...
    	colaboradorTurmaManager.expects(once()).method("findByTurma").with(eq(10L)).will(returnValue(new ArrayList<ColaboradorTurma>()));
    ...
    public void testGetColaboradoresByFiltro() throws Exception
    {
    	...
    	colaboradorTurmaManager.expects(once()).method("findAprovadosByCertificacao").with(ANYTHING).will(returnValue(new ArrayList<Colaborador>()));
