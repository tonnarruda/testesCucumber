...
public class ExamesPrevistosRelatorioTest extends TestCase
{
	...
	ExamesPrevistosRelatorio examesPrevistosRelatorio = new ExamesPrevistosRelatorio(1L,1L,1L,"Cargo","001", "Colaborador","Colab Comercial","Exame",dataExame,dataExame,1, "PERIODICO",1L,"EST");
	...
	public void testGetTempoVencido()
	{
		...
		examesPrevistosRelatorio = new ExamesPrevistosRelatorio(1L,1L,1L,"Cargo","00001","Colaborador","Colab Comercial","Exame",calendar.getTime(),calendar.getTime(),1, "PERIODICO",1L,"EST");
	...
	public void testGetSet()
	{
		...
		examesPrevistosRelatorio = new ExamesPrevistosRelatorio(1L,1L,1L,"Cargo","00001","Maria","Colab Comercial","Audiometria",new Date(),new Date(), 1, "PERIODICO",1L,"EST");
		...
		examesPrevistosRelatorio = new ExamesPrevistosRelatorio(1L,1L,1L,"Cargo","00001","Maria","Colab Comercial","Audiometria",new Date(),null, 1, "PERIODICO",1L,"EST");
