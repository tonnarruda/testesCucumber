...
public class ColaboradorRespostaManagerTest extends MockObjectTestCase
{
    ...
    public void testCountRespostas()
    {
    	...
    	colaboradorRespostaDao.expects(once()).method("countRespostas").with(new Constraint[]{ANYTHING, ANYTHING, eq(areasIds), ANYTHING, ANYTHING, ANYTHING}).will(returnValue(lista));
    ...
    public void testFindInPerguntaIds()
    {
    	...
    	colaboradorRespostaDao.expects(once()).method("findInPerguntaIds").with(new Constraint[]{eq(perguntasIds), ANYTHING, eq(areasIds), ANYTHING, ANYTHING, ANYTHING, ANYTHING}).will(returnValue(colaboradorRespostas));

    	assertEquals(colaboradorRespostas, colaboradorRespostaManager.findInPerguntaIds(perguntasIds, null, areasIds, null, null, null, null));
    }
    ...
    public void testCalculaPercentualRespostas()
    {
    	...
    	colaboradorRespostaDao.expects(once()).method("countRespostas").with(new Constraint[]{eq(perguntasIds), ANYTHING, eq(areasIds), ANYTHING, ANYTHING, ANYTHING}).will(returnValue(countRespostas));
    	Collection<QuestionarioResultadoPerguntaObjetiva> resultadosObjetivas = colaboradorRespostaManager.calculaPercentualRespostas(perguntasIds, null, areasIds, null, null, null);
    ...
    public void testCalculaPercentualRespostasMultipla()
    {
    	...
    	colaboradorRespostaDao.expects(once()).method("countRespostasMultiplas").with(new Constraint[]{eq(perguntasIds), ANYTHING, eq(areasIds), ANYTHING, ANYTHING, ANYTHING}).will(returnValue(countRespostas));
    	Collection<QuestionarioResultadoPerguntaObjetiva> resultadosMultiplas = colaboradorRespostaManager.calculaPercentualRespostasMultipla(perguntasIds, null, areasIds, null, null, null, 2);
