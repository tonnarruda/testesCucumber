...
public class QuantidadeLimiteColaboradoresPorCargoManagerTest extends MockObjectTestCase
{
	...
	public void testValidaLimite() 
	{
		...
		areaOrganizacionalManager.expects(atLeastOnce()).method("findAllSelectOrderDescricao").with(eq(empresa.getId()), eq(Boolean.TRUE)).will(returnValue(areasOrganizacionais));
