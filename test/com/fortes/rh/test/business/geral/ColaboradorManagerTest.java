...
public class ColaboradorManagerTest extends MockObjectTestCase
{
    ...
    {
    	Collection<Colaborador> colaboradores = new ArrayList<Colaborador>();
    	Colaborador joao1 = new Colaborador(1L, "joão da silva", "joão", "pedro", null, 20.20, false, 20L, "prova", "vega");
    	Colaborador joao2 = new Colaborador(1L, "joão da silva", "joão", "pedro", null, 55.00, false, 21L, "prova II", "vega");
    	
    	colaboradores.add(joao1);
    	colaboradores.add(joao2);
    	
    	Colaborador chico1 = new Colaborador(2L, "chico paulo", "chico", "pedro", null, 15.00, false, 21L, "prova II", "vega");
    	Colaborador chico2 = new Colaborador(2L, "chico paulo", "chico", "pedro", null, 75.00, false, 23L, "prova III", "vega");
