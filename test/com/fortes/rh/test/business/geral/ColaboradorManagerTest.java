...
public class ColaboradorManagerTest extends MockObjectTestCase
{
    ...
    public void testFindAreaOrganizacionalByAreas()
    {
        ...
        colaboradorDao.expects(once()).method("findAreaOrganizacionalByAreas").with(new Constraint[]{ANYTHING,ANYTHING,ANYTHING,ANYTHING,ANYTHING}).will(returnValue(colaboradors));

        Collection<Colaborador> retorno = colaboradorManager.findAreaOrganizacionalByAreas(false, null, null, null, null);
