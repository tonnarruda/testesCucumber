...
//		assertNull(msg);
    ...
    public void testSaveEmpregadosESituacoes() throws Exception
    {
    	...
    	mocksTestSaveEmpregadosESituacoes(empresa, estado, cidade, tSituacoes);
	...
	private void mocksTestSaveEmpregadosESituacoes(Empresa empresa,	Estado estado, Cidade cidade, TSituacao[] tSituacoes) {
