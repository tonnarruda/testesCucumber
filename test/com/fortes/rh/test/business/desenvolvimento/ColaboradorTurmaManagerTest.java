...
public class ColaboradorTurmaManagerTest extends MockObjectTestCase
{
	...
	public void testFiltrarColaboradores() throws Exception
	{
		...
		colaboradorManager.expects(once()).method("findByAreasOrganizacionalIds").with(new Constraint[]{eq(page), eq(pagingSize), ANYTHING, ANYTHING, ANYTHING, ANYTHING,ANYTHING, ANYTHING, ANYTHING, ANYTHING}).will(returnValue(colaboradores));
	...
	public void testGetTreinamentosPrevistoParaTRU()
	{
		Empresa empresa = EmpresaFactory.getEmpresa(1L);
	...
	public void testGetTreinamentosRealizadosParaTRU()
	{
		...
		DiaTurma diaTurma1 = DiaTurmaFactory.getEntity(1L);
		diaTurma1.setTurma(turma);
		diaTurma1.setDia(DateUtil.criarDataMesAno(1, 12, 2014));
		
		DiaTurma diaTurma2 = DiaTurmaFactory.getEntity(2L);
		diaTurma2.setTurma(turma);
		diaTurma2.setDia(DateUtil.criarDataMesAno(2, 12, 2014));
		
		DiaTurma diaTurma3 = DiaTurmaFactory.getEntity(3L);
		diaTurma3.setTurma(turma);
		diaTurma3.setDia(DateUtil.criarDataMesAno(3, 12, 2014));
		
		Collection<DiaTurma> diasTurma = new ArrayList<DiaTurma>();
		diasTurma.add(diaTurma1);
		diasTurma.add(diaTurma2);
		diasTurma.add(diaTurma3);
		...
		ColaboradorPresenca colabPresenca1 = ColaboradorPresencaFactory.getEntity();
		colabPresenca1.setColaboradorTurma(ct1);
		colabPresenca1.setDiaTurma(diaTurma1);
		
		ColaboradorPresenca colabPresenca2 = ColaboradorPresencaFactory.getEntity();
		colabPresenca2.setColaboradorTurma(ct1);
		colabPresenca2.setDiaTurma(diaTurma2);
		
		ColaboradorPresenca colabPresenca3 = ColaboradorPresencaFactory.getEntity();
		colabPresenca3.setColaboradorTurma(ct1);
		colabPresenca3.setDiaTurma(diaTurma3);

		ColaboradorPresenca colabPresenca4 = ColaboradorPresencaFactory.getEntity();
		colabPresenca4.setColaboradorTurma(ct2);
		colabPresenca4.setDiaTurma(diaTurma3);
		
		Collection<ColaboradorPresenca> colaboradorPresencas = new ArrayList<ColaboradorPresenca>();
		colaboradorPresencas.add(colabPresenca1);
		colaboradorPresencas.add(colabPresenca2);
		colaboradorPresencas.add(colabPresenca3);
		colaboradorPresencas.add(colabPresenca4);
		
		colaboradorTurmaDao.expects(once()).method("findTurmaRealizadaByCodigoAc").withAnyArguments().will(returnValue(colabTurmas));
		...
		assertEquals(6, tAula.length);
		assertEquals("01/12/2014", ((TAula) tAula[0]).getData());
		assertEquals("02/12/2014", ((TAula) tAula[1]).getData());
		assertEquals("03/12/2014", ((TAula) tAula[2]).getData());
		assertEquals("01/12/2014", ((TAula) tAula[3]).getData());
