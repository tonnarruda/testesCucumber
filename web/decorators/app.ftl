	...
	<div id="waDiv">
	 	<div style="position:fixed;" class="box_icones">	
			<div id="icones" style="top: 30px; margin-top:-16px; width: 33px; background: white; border-radius: 5px;padding: 10px;position: absolute;" class="icones">
		        ...
		        <a href='http://blog.fortestecnologia.com.br/fortes-rh/' target='_blank' title='Blog'><img src="<@ww.url includeParams="none" value="/imgs/blog.png"/>" class="icon" onmouseover="this.style='opacity: 0.6;display: block; padding: 4px;'" onmouseout="this.style='opacity: 1;display: block; padding: 4px;'" height="32" width="32" style="display: block; padding: 4px;" /></a>
