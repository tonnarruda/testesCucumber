	...
	<@display.table name="avaliacaoTurmas" id="avaliacaoTurma" class="dados">
		<@display.column title="Ações" style="width:155px">
			...
			<#if avaliacaoTurma.questionario.aplicarPorAspecto>
				<a href="javascript: executeLink('../questionario/prepareAplicarByAspecto.action?questionario.id=${avaliacaoTurma.questionario.id}&preview=true');"><img border="0" title="Visualizar Questionário de Avaliação" src="<@ww.url includeParams="none" value="/imgs/olho.jpg"/>"></a>
			<#else>
				<a href="javascript: executeLink('../questionario/prepareAplicar.action?questionario.id=${avaliacaoTurma.questionario.id}&preview=true');"><img border="0" title="Visualizar Questionário de Avaliação" src="<@ww.url includeParams="none" value="/imgs/olho.jpg"/>"></a>
			</#if>

			<a href="javascript: executeLink('prepareUpdate.action?avaliacaoTurma.id=${avaliacaoTurma.id}&quantidadeDeResposta=${avaliacaoTurma.questionario.quantidadeDeResposta}');"><img border="0" title="<@ww.text name="list.edit.hint"/>" src="<@ww.url includeParams="none" value="/imgs/edit.gif"/>"></a>
			...
			<#else>
				<a href="javascript: executeLink('../pergunta/list.action?questionario.id=${avaliacaoTurma.questionario.id}');"><img border="0" title="Questionário da avaliação" src="<@ww.url includeParams="none" value="/imgs/question.gif"/>"></a>
				<a href="javascript: executeLink('../aspecto/list.action?questionario.id=${avaliacaoTurma.questionario.id}');"><img border="0" title="Aspectos da avaliação" src="<@ww.url includeParams="none" value="/imgs/agrupar.gif"/>"></a>
			</#if>
			...
			<#else>
				<a href="javascript:newConfirm('Confirma exclusão?', function(){executeLink('delete.action?avaliacaoTurma.id=${avaliacaoTurma.id}&avaliacaoTurma.questionario.empresa.id=${avaliacaoTurma.questionario.empresa.id}&page=${page}');});"><img border="0" title="<@ww.text name="list.del.hint"/>" src="<@ww.url includeParams="none" value="/imgs/delete.gif"/>"></a>
			</#if>
			<a href="javascript: executeLink('../questionario/imprimir.action?questionario.id=${avaliacaoTurma.questionario.id}');"><img border="0" title="Imprimir" src="<@ww.url includeParams="none" value="/imgs/printer.gif"/>"></a>
			<a href="javascript: executeLink('../questionario/imprimir.action?questionario.id=${avaliacaoTurma.questionario.id}&imprimirFormaEconomica=true');"><img border="0" title="Imprimir em formato econômico" src="<@ww.url includeParams="none" value="/imgs/iconPrint.gif"/>"></a>
		</@display.column>
