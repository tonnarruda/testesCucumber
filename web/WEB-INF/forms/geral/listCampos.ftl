...
<head>
<@ww.head/>
	<title>Configurar Cadastro de Colaborador e Candidato</title>
</head>
<body>
	<style type="text/css">
		.configCampos {
	...
	<div id="menuCadastro">	
		<@authz.authorize ifAllGranted="ROLE_CONFIG_CAMPOS_COLABORADOR">			
			<a href="javascript:showBox('colaborador');" class="colaborador">Colaborador</a>
		</@authz.authorize>
		<@authz.authorize ifAllGranted="ROLE_CONFIG_CAMPOS_CANDIDATO">			
			<a href="javascript:showBox('candidato');" class="candidato">Candidato</a>
		</@authz.authorize>
		<@authz.authorize ifAllGranted="ROLE_CONFIG_CAMPOS_CANDIDATO_EXT">			
