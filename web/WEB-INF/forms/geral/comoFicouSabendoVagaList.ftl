...
<body>
	...
	<@display.table name="comoFicouSabendoVagas" id="comoFicouSabendoVaga" class="dados">
		<@display.column title="Ações" class="acao">
			...
			<a href="#" onclick="newConfirm('Confirma exclusão?', function(){ window.location='delete.action?comoFicouSabendoVaga.id=${comoFicouSabendoVaga.id}' });"><img border="0" title="Excluir" src="<@ww.url value="/imgs/delete.gif"/>"></a>
		</@display.column>
