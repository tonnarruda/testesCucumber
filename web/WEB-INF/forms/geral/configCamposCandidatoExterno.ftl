	...
	<div class="content1">
		<table id="abaDadosPessoais" cellspacing="0" class="configCampos">
			...
			<tr>
				...
				<td>
					<input id="checkFone" type="checkbox" class="checkCampoComposto" value="fone" name="camposObrigatorios" onchange="validaCampoCompostoObrigatorio(this)"/>
			...
			<tr>
				...
				<td>
					<input id="checkCelular" type="checkbox" class="checkCampoComposto" value="celular" name="camposObrigatorios" onchange="validaCampoCompostoObrigatorio(this)"/>
	...
	<div class="content5">
		<table id="abaDocumentos" cellspacing="0" class="configCampos">
			...
			<tr>
				...
				<td>
					<input id="checkIdentidade" type="checkbox" class='checkCampoComposto' type="checkbox" name="camposObrigatorios"  value="identidade" onchange="validaCampoCompostoObrigatorio(this)" />
