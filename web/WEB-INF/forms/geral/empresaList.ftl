...
<body>
	...
	<@display.table name="empresas" id="empresa" class="dados" defaultsort=2 >
		<@display.column title="Ações" style="text-align:center; width: 80px" media="html">
			<a href="javascript: executeLink('prepareUpdate.action?empresa.id=${empresa.id}');"><img border="0" title="<@ww.text name="list.edit.hint"/>" src="<@ww.url includeParams="none" value="/imgs/edit.gif"/>"></a>
			...
			<a href="#" onclick="newConfirm('${msgDelete}', function(){executeLink('delete.action?empresa.id=${empresa.id}');});"><img border="0" title="<@ww.text name="list.del.hint"/>" src="<@ww.url includeParams="none" value="/imgs/delete.gif"/>"></a>
