...
<body>
	...
	<@display.table name="documentoAnexos" id="documentoAnexo" pagesize=10 class="dados" defaultsort=2 sort="list">
		...
		<@display.column title="Ações" class="acao" style="width:90px">
			...
			<a href="${editar}documentoAnexo.id=${documentoAnexo.id}&documentoAnexo.origem=${documentoAnexo.origem}&documentoAnexo.origemId=${documentoAnexo.origemId}&origemDocumento=${origemDocumento}&origemIdDocumento=${origemIdDocumento}"><img border="0" title="<@ww.text name="list.edit.hint"/>" src="<@ww.url value="/imgs/edit.gif"/>"></a>
			<a href="#" onclick="newConfirm('Confirma exclusão?', function(){window.location='${deletar}documentoAnexo.id=${documentoAnexo.id}&documentoAnexo.origem=${origemDocumento}&documentoAnexo.origemId=${origemIdDocumento}'});"><img border="0" title="Excluir" src="<@ww.url value="/imgs/delete.gif"/>"></a>
		</@display.column>
