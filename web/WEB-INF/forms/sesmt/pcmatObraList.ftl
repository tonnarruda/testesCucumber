...
<body>
	...
	<@display.table name="pcmats" id="pcmat" class="dados">
		<@display.column title="Ações" class="acao">
			...
			<#if ultimoPcmat?exists && ultimoPcmat.id ==  pcmat.id>
				<a href="javascript:;" onclick="javascript:clonar();"><img border="0" title="Clonar" src="<@ww.url includeParams="none" value="/imgs/clonar.gif"/>"></a>
	...
	<div id="formDialog">
		<@ww.form name="formModal" id="formModal" action="clonar.action" method="POST" onsubmit="${validarCamposClonar}">
			<@ww.datepicker label="Data do PCMAT" name="pcmat.aPartirDe" id="aPartirDe" required="true" cssClass="mascaraData"/>
