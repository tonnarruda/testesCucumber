...
<body>
	...
	<div class="buttonGroup">
		...
		<button onclick="javascript: executeLink('../funcao/prepareUpdate.action?funcao.id=${funcao.id}&cargoTmp.id=${cargoTmp.id}&veioDoSESMT=${veioDoSESMT?string}');" class="btnCancelar"></button>
	</div>
</body>
</html>