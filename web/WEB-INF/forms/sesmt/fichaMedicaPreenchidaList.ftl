...
<body>
	...
	<#if colaboradorQuestionarios?exists && 0 < colaboradorQuestionarios?size>
		<@display.table name="colaboradorQuestionarios" id="colaboradorQuestionario" pagesize=20 class="dados">
			<@display.column title="Ações" class="acao" style="text-align: center;width:80px;">
				<a href="javascript: executeLink('../../sesmt/fichaMedica/prepareEditFichaMedica.action?colaboradorQuestionario.id=${colaboradorQuestionario.id}');"><img border="0" title="<@ww.text name="list.edit.hint"/>" src="<@ww.url value="/imgs/edit.gif"/>"></a>
				<a href="#" onclick="newConfirm('Confirma exclusão?', function(){executeLink('deletePreenchida.action?colaboradorQuestionario.id=${colaboradorQuestionario.id}');});"><img border="0" title="Excluir" src="<@ww.url value="/imgs/delete.gif"/>"></a>
				<a href="javascript: executeLink('../../sesmt/fichaMedica/imprimirFichaMedica.action?colaboradorQuestionario.id=${colaboradorQuestionario.id}&questionario.id=${colaboradorQuestionario.questionario.id}');"><img border="0" title="Imprimir ficha" src="<@ww.url includeParams="none" value="/imgs/printer.gif"/>"></a>
			</@display.column>
	...
	<div class="buttonGroup">
		<button onclick="javascript: executeLink('prepareInsertFicha.action');" class="btnInserir"></button>
	</div>
