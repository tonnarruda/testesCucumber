...
<body>
	...
	<@display.table name="etapaSeletivas" id="etapaSeletiva" class="dados">
		<@display.column title="Ações" media="html" class="acao">
			...
			<a href="#" onclick="if (confirm('Confirma exclusão?')) window.location='delete.action?etapaSeletiva.id=${etapaSeletiva.id}'"><img border="0" title="<@ww.text name="list.del.hint"/>" src="<@ww.url includeParams="none" value="/imgs/delete.gif"/>"></a>
		</@display.column>
