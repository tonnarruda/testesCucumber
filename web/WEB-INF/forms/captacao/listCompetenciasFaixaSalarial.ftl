...
<body>
	...
	<@display.table name="configuracaoNivelCompetenciaFaixasSalariais" id="cncFaixaSalarial" class="dados">
	...
	<div class="buttonGroup">
		...
		<button class="btnInserir" onclick="window.location='prepareCompetenciasByFaixa.action?faixaSalarial.id=${faixaSalarial.id}'"></button>
