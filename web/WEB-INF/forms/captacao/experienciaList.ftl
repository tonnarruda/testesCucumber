	...
	<@display.table name="experiencias" id="exp" class="dados" defaultsort=4 defaultorder="descending">
		<@display.column title="Ações" media="html" class="acao">
			...
			<a href="javascript:if (confirm('Confirma exclusão?')) removeExperiencia(${exp.id?string?replace(".", "")?replace(",","")})"><img border="0" title="<@ww.text name="list.del.hint"/>" src="<@ww.url includeParams="none" value="/imgs/delete.gif"/>"></a>
		</@display.column>
