...
<@ww.form name="form" action="${formAction}" onsubmit="${validarCampos}" validate="true" method="POST">
	...
	<@ww.textfield label="Peso" name="habilidade.peso" id="peso" size="4"  maxLength="4" required="true" onkeypress="return(somenteNumeros(event,''));" cssStyle="width:40px; text-align:right;"/>
