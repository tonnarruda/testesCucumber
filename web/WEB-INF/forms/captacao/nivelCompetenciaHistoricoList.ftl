...
<body>
	...
	<@display.table name="nivelCompetenciaHistoricos" id="nivelCompetenciaHistorico" class="dados" defaultsort=2 style="width: 200px">
		<@display.column title="Ações" class="acao">
			<a href="../configHistoricoNivel/list.action?nivelCompetenciaHistorico.id=${nivelCompetenciaHistorico.id}"><img border="0" title="Editar" src="<@ww.url value="/imgs/edit.gif"/>"></a>
