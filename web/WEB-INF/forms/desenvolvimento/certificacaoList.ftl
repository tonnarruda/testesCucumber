...
<#include "../ftl/showFilterImports.ftl" />
	...
	<body>
		...
		<@display.table name="certificacaos" id="certificacao" pagesize=10 class="dados">
			<@display.column title="Ações" class="acao">
				...
				<a href="#" onclick="if (confirm('Confirma exclusão?')) window.location='delete.action?certificacao.id=${certificacao.id}'"><img border="0" title="Excluir" src="<@ww.url value="/imgs/delete.gif"/>"></a>
