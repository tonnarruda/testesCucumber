...
<head>
<@ww.head/>
	<title>Relatório de Última Promoção</title>
	...
	<#assign validarCampos="return validaFormulario('form', false, false, false)"/>
</head>
...
<body>
	...
	<@ww.form name="form" action="imprimirRelatorioUltimaPromocao.action" onsubmit="${validarCampos}" validate="true" method="POST">
