...
<body>
	...
	<@display.table name="indices" id="indice" class="dados">
		<@display.column title="Ações" class="acao">
			...
			<#if !integradoAC>
				<a href="#" onclick="if (confirm('Confirma exclusão?')) window.location='delete.action?indiceAux.id=${indice.id}'"><img title="<@ww.text name="list.del.hint"/>" src="<@ww.url value="/imgs/delete.gif"/>"></a>
			</#if>
		</@display.column>
