...
<body>
	...
	<@display.table name="faixaSalarialHistoricos" id="faixaSalarialHistorico" pagesize=10 class="dados">
		<@display.column title="Ações" class="acao">
			...
			<a href="#" onclick="if (confirm('Confirma exclusão?')) window.location='delete.action?faixaSalarialHistorico.id=${faixaSalarialHistorico.id}'"><img border="0" title="Excluir" src="<@ww.url value="/imgs/delete.gif"/>"></a>
		</@display.column>
