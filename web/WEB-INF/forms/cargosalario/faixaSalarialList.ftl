...
<body>
	...
	<@display.table name="faixaSalarials" id="faixaSalarial" pagesize=10 class="dados" defaultsort=2 sort="list">
		<@display.column title="Ações" class="acao">
			<a href="../../captacao/nivelCompetencia/prepareCompetenciasByFaixa.action?faixaSalarial.id=${faixaSalarial.id}"><img border="0" title="Níveis de Competência" src="<@ww.url value="/imgs/medalha.gif"/>"></a>
