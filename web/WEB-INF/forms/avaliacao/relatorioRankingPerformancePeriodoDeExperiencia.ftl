...
<body>
	...
	<@ww.actionmessage />
		...
		<div class="buttonGroup">
			...
			<button class="btnRelatorioExportar" onclick="jQuery('form[name=form]').attr('action', 'imprimeRelatorioRankingPerformancePeriodoDeExperienciaXLS.action');${validarCampos};">
		</button>
