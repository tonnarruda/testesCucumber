INSERT INTO papel (id, codigo, nome, url, ordem, menu, papelmae_id) VALUES (530, 'ROLE_CAD_NATUREZALESAO', 'Natureza de Lesão', '/sesmt/naturezaLesao/list.action', 14, true, 385); --.go
