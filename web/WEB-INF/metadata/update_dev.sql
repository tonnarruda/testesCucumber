...
insert into papel values (nextval('papel_sequence'), 'ROLE_REL_ACOMPANHAMENTO_EXPERIENCIA', 'Periodo de Acompanhamento de Experiência',
 '/avaliacao/periodoExperiencia/prepareRelatorioAcopanhamentoExperiencia.action', 2, 't', null, 486);
 ...
 '/avaliacao/periodoExperiencia/prepareRelatorioRankingPerformancePeriodoDeExperiencia.action', 3, 't', null, 486);
