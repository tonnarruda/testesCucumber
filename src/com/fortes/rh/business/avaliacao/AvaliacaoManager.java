...
public interface AvaliacaoManager extends GenericManager<Avaliacao>
{
	...
	Collection<ResultadoQuestionario> montaResultado(Collection<Pergunta> perguntas, Long[] perguntasIds, Long[] areaIds, Date periodoIni, Date periodoFim, Avaliacao avaliacao, Long empresaId, Character tipoModeloAvaliacao, boolean ocultarQtdRespostas) throws Exception;
