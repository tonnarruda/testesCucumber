...
public interface ColaboradorOcorrenciaManager extends GenericManager<ColaboradorOcorrencia>
{
	...
	Collection<Object[]> montaGraficoAbsenteismo(String dataMesAnoIni, String dataMesAnoFim, Collection<Long> empresaIds, Collection<Long> areasIds, Collection<Long> cargosIds, boolean considerarSabadoNoAbsenteismo);
