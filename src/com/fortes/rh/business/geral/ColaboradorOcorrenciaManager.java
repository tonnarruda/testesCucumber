...
public interface ColaboradorOcorrenciaManager extends GenericManager<ColaboradorOcorrencia>
{
	...
	Collection<ColaboradorOcorrencia> babau(Empresa empresa, Date dataIni, Date dataFim, Long[] ocorrenciaIds, Collection<Long> areaIds, Collection<Long> estabelecimentoIds, Collection<Long> colaboradorIds);
}