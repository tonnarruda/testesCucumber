...
//			}
	...
	public Collection<AreaOrganizacional> findAllList(Long idUsuario, Long empresaId, Boolean ativo)
	{
		return getDao().findAllList(0, 0, idUsuario, null, empresaId, ativo);
	}
