...
public class ColaboradorManagerImpl extends GenericManagerImpl<Colaborador, ColaboradorDao> implements ColaboradorManager
{
	...
	{
		return getDao().updateDataDesligamentoByCodigo(codigoAC, empresa, null);
	}
...
//	}
	...
	{
		return getDao().findAreaOrganizacionalByAreas((Collection<Long>) filtros.get("estabelecimentos"), (Collection<Long>) filtros.get("areas"), ((CamposExtras)filtros.get("camposExtras")), habilitaCampoExtra);
	}
	...
	{
		return getDao().findByCodigoAC(empregadoCodigoAC, empresaCodigoAC);
	}
