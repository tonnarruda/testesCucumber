...
public interface CandidatoManager extends GenericManager<Candidato>
{
	...
	public Collection<Candidato> busca(Map<String, Object> parametros, Long empresa, Long solicitacaoId, boolean somenteSemSolicitacao, Integer qtdRegistros) throws Exception;
