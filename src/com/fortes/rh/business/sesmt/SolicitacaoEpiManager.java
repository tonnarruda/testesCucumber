...
public interface SolicitacaoEpiManager extends GenericManager<SolicitacaoEpi>
{
	...
	Collection<SolicitacaoEpi> findRelatorioVencimentoEpi(Long empresaId, Date vencimento, char agruparPor, boolean exibirVencimentoCA) throws ColecaoVaziaException;
