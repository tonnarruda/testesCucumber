...
public interface ExameManager extends GenericManager<Exame>
{
	...
	Collection<ExamesPrevistosRelatorio> findRelatorioExamesPrevistos(Long empresaId, Date dataInicio, Date dateFim, Long[] examesIds, Long[] estabelecimentosIds, Long[] areasIds, Long[] colaboradoresIds, char agruparPor, boolean imprimirAfastados, boolean imprimirDesligados, boolean exibirExamesNaoRealizados) throws ColecaoVaziaException, Exception;
