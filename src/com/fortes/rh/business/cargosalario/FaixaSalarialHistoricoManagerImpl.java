...
public class FaixaSalarialHistoricoManagerImpl extends GenericManagerImpl<FaixaSalarialHistorico, FaixaSalarialHistoricoDao> implements FaixaSalarialHistoricoManager
{
	...
	public Collection<FaixaSalarialHistorico> findByGrupoCargoAreaData(String[] grupoOcupacionalsCheck, String[] cargosCheck, String[] areasCheck, Date data, boolean ordemDataDescendente) throws Exception
	{
		...
		Collection<FaixaSalarialHistorico> retorno = getDao().findByGrupoCargoAreaData(grupoOcupacionalIds, cargoIds, areaIds, data, ordemDataDescendente);
