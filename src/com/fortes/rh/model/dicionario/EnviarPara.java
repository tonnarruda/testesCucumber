...
public enum EnviarPara
{
	...
	public static void setPerfilAutorizadoVisualizarSolicitacaoPessoal(HashMap<Integer, String> enviarPara) {
		enviarPara.put(EnviarPara.PERFIL_AUTORIZADO_VISUALIZAR_SOLICITACAO_PESSOAL.getId(), EnviarPara.PERFIL_AUTORIZADO_VISUALIZAR_SOLICITACAO_PESSOAL.getDescricao());
	}
}