...
public class ErroFeedBackACPessoal extends LinkedHashMap<Object, Object>
{
	...
	static{
		mensagens.put(AREAORGANIZACIONAL_NIVEL_EXCEDIDO, "Esta área organizacional não poderá ser cadastrada contendo a área mãe selecionada, pois o nível de hierarquia será excedido de acordo com as configurações de mascara da lotação no AC Pessoal.");
	}
