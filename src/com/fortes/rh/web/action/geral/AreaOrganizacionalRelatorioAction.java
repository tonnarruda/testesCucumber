...
public class AreaOrganizacionalRelatorioAction extends MyActionSupport
{
	...
	public String gerarRelatorio() throws Exception
	{
		...
		try
		{
			...
			dataSource = colaboradorManager.findAreaOrganizacionalByAreas(habilitaCampoExtra, estabelecimentos, areas, camposExtras, empresa.getId(), null, null, null, null, null, null);
