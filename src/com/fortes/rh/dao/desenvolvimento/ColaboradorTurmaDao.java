...
public interface ColaboradorTurmaDao extends GenericDao<ColaboradorTurma>
{
	...
	Collection<ColaboradorTurma> findByTurma(Long turmaId);
	...
	Collection<ColaboradorTurma> getColaboradoresByTurma(Collection<Long> turmaIds);
	...
	Collection<ColaboradorTurma> findByIdProjection(Long[] ids);
	...
	Collection<ColaboradorTurma> findAllSelect(Collection<Long> colaboradorTurmaIds);
