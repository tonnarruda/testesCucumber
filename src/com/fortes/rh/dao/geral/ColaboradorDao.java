...
public interface ColaboradorDao extends GenericDao<Colaborador>
{
	...
	public Collection<Colaborador> findByNomeCpfMatriculaAndResponsavelArea(Colaborador colaborador, Long id, Long[] areasIds);
	...
	public Collection<DataGrafico> countEstadoCivil(Date data, Collection<Long> empresaId, Long[] areasIds, Long[] cargosIds);
