...
public class ColaboradorRespostaDaoHibernate extends GenericDaoHibernate<ColaboradorResposta> implements ColaboradorRespostaDao
{
	...
	public Collection<RespostaQuestionarioVO> findRespostasAvaliacaoDesempenho(Long colaboradorQuestionarioId) 
	{
		...
		hql.append("select cq.id, p.id as pergunta_id, p.ordem as pergunta_ordem, p.texto as pergunta_texto, p.comentario as pergunta_comentario, p.textocomentario as pergunta_textocomentario, p.tipo as pergunta_tipo, ");
		...
		for (Object[] obj : lista) {
			i = 0;
			vos.add(new RespostaQuestionarioVO((Long)obj[i++], (Long)obj[i++], (Integer)obj[i++], (String)obj[i++], (Boolean)obj[i++], (String)obj[i++], (Integer)obj[i++], (Long)obj[i++], (Integer)obj[i++], (String)obj[i++], (Integer)obj[i++], (Long)obj[i++], (String)obj[i++], (String)obj[i++], (Long)obj[i++], (Integer)obj[i++], (String)obj[i++]));
		}
		return vos;
	}
}