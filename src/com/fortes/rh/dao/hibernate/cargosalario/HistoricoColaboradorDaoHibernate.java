...
public class HistoricoColaboradorDaoHibernate extends GenericDaoHibernate<HistoricoColaborador> implements HistoricoColaboradorDao
{
	...
	{
		hql.append("select new HistoricoColaborador(hc.id, hc.salario, hc.data, hc.gfip, hc.motivo, hc.quantidadeIndice, hc.tipoSalario, hc.status, hc.candidatoSolicitacao.id, ");
		...
		hql.append("fs.codigoAC, ao.codigoAC, es.codigoAC, fsh.status, hc.movimentoSalarialId, hc.reajusteColaborador.id) ");
	}
