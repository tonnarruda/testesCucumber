...
public class SolicitacaoDaoHibernate extends GenericDaoHibernate<Solicitacao> implements SolicitacaoDao
{
	...
	public Solicitacao getValor(Long solcitacaoId)
	{
		...
		hql.append("						areaOrganizacional.id, ");
		hql.append("						cast(monta_familia_area(areaOrganizacional.id), text) as areaNome, ");
		...
		hql.append("						motivoSolicitacao.id, ");
		hql.append("						motivoSolicitacao.considerarQtdColaboradoresPorCargo) ");
		...
		hql.append("	left join solicitacao.motivoSolicitacao motivoSolicitacao ");
	...
	public Solicitacao findByIdProjectionForUpdate(Long solicitacaoId)
	{
		...
		p.add(Projections.property("s.sexo"), "sexo");
		p.add(Projections.property("s.quantidade"), "quantidade");
		p.add(Projections.property("s.experiencias"), "experiencias");
