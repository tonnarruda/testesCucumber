...
public class EmpresaDaoHibernate extends GenericDaoHibernate<Empresa> implements EmpresaDao
{
	...
	public void removeEmpresaPadrao(long id) 
	{
		...
		String[] sqls = new String[]{
				...
				"delete from solicitacaoepiitementrega   where solicitacaoepiitem_id  in (select id from solicitacaoepi_item where epi_id in (select id from epi where empresa_id ="+id +" ));",
				"delete from solicitacaoepiitemdevolucao where solicitacaoepiitem_id  in (select id from solicitacaoepi_item where epi_id in (select id from epi where empresa_id ="+id +" ));",
				"delete from solicitacaoepi_item where epi_id  in ( select id from epi where empresa_id ="+ id +" );",
				...
				"delete from epipcmat where epi_id in (select id from epi where empresa_id="+ id +");",
				"delete from historicofuncao_epi where epis_id in(select id from epi where empresa_id ="+id+");",
				"delete from cat_epi where epis_id in (select id from epi where empresa_id=" +id+");",
