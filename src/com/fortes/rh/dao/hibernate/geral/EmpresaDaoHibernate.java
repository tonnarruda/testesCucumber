...
public class EmpresaDaoHibernate extends GenericDaoHibernate<Empresa> implements EmpresaDao
{
	...
	public void removeEmpresaPadrao(long id) 
	{
		...
		String[] sqls = new String[]{
				"delete from atitude_curso where cursos_id in (select id from curso where empresa_id = " + id + ");",
				"delete from conhecimento_curso where cursos_id in (select id from curso where empresa_id = " + id + ");",
				"delete from habilidade_curso where cursos_id in (select id from curso where empresa_id = " + id + ");",
				"delete from certificacao_curso where cursos_id in (select id from curso where empresa_id = " + id + ");",
				"delete from curso_avaliacaocurso where cursos_id in (select id from curso where empresa_id = " + id + ");",
				"delete from curso_empresa where cursos_id in (select id from curso where empresa_id = " + id + ");",
				"delete from aproveitamentoavaliacaocurso where colaboradorturma_id in (select id from colaboradorturma where colaborador_id in (select id from colaborador where empresa_id = " + id + "));",
				"delete from colaboradorresposta where colaboradorquestionario_id in (select id from colaboradorquestionario where turma_id in (select id from turma where curso_id in (select id from curso where empresa_id = " + id + ")));",
				...
				"delete from turma_documentoanexo where turma_id in (select id from turma where curso_id in (select id from curso where empresa_id = " + id + "));",
				"delete from turma where curso_id in (select id from curso where empresa_id = " + id + ");",
				"delete from curso where empresa_id = " + id + ";",
				...
				"update colaboradorturma set cursoLnt_id = null where cursoLnt_id in (select id from cursoLnt where lnt_id not in (select lnt_id from lnt_empresa));",
				...
				"delete from historicocandidato where candidatosolicitacao_id in (select id from candidatosolicitacao where solicitacao_id in (select id from solicitacao where empresa_id = " + id + "));",
				...
				"delete from solicitacao_bairro where solicitacao_id in (select id from solicitacao where empresa_id = " + id + ");",
				...
				"delete from historicocolaborador where faixasalarial_id in (select id from faixasalarial where cargo_id in (select id from cargo where empresa_id = " + id + "));",
				...
				"delete from configuracaonivelcompetenciacolaborador where colaborador_id in (select id from colaborador where empresa_id = " + id + ");",
				"delete from configuracaonivelcompetenciacandidato where configuracaonivelcompetenciafaixasalarial_id in (select id from configuracaonivelcompetenciafaixasalarial where nivelcompetenciahistorico_id in (select id from nivelcompetenciahistorico where empresa_id = " + id + "));",
				"delete from configuracaonivelcompetenciacandidato where solicitacao_id in (select id from solicitacao where empresa_id = " + id + ");",
				"delete from configuracaonivelcompetenciacandidato where candidato_id in (select id from candidato where empresa_id = " + id + ");",
				...
				"delete from colaboradorresposta where cargo_id in (select id from cargo where empresa_id = " + id + ");",
				"delete from historicofuncao where funcao_id in (select id from funcao where empresa_id = " + id + ");",
				"delete from funcao where empresa_id = " + id + ";",
				...
				"delete from historicocolaborador where areaorganizacional_id in (select id from areaorganizacional where empresa_id = " + id + ");",
				"delete from areaorganizacional where empresa_id = " + id + ";",
				"delete from candidato_areainteresse where areasinteresse_id in (select id from areainteresse where empresa_id = " + id + ");",
				...
				"delete from candidato_areainteresse where candidato_id in (select id from candidato where empresa_id = " + id + ");",
				"delete from candidatosolicitacao where candidato_id in (select id from candidato where empresa_id = " + id + ");",
				"delete from colaboradorquestionario where candidato_id in (select id from candidato where empresa_id = " + id + ");",
				"delete from candidato where empresa_id = " + id + ";",
				"delete from configuracaoimpressaocurriculo where empresa_id = " + id + ";",
				"delete from faturamentomensal where estabelecimento_id in (select id from estabelecimento where empresa_id = " + id + ");",
				"delete from eleicao where estabelecimento_id in (select id from estabelecimento where empresa_id = " + id + ");",
				"delete from colaboradorresposta where estabelecimento_id in (select id from estabelecimento where empresa_id = " + id + ");",
				"delete from historicocolaborador where estabelecimento_id in (select id from estabelecimento where empresa_id = " + id + ");",
				"delete from medicocoordenador_estabelecimento where estabelecimentos_id in (select id from estabelecimento where empresa_id = " + id + ");",
				"delete from engenheiroresponsavel_estabelecimento where estabelecimentos_id in (select id from estabelecimento where empresa_id = " + id + ");",
				...
				"delete from colaboradorresposta where colaboradorquestionario_id in (select id from colaboradorquestionario where colaborador_id in (select id from colaborador where empresa_id = " + id + "));",
				"delete from colaboradorresposta where colaboradorquestionario_id in (select id from colaboradorquestionario where candidato_id in (select id from candidato where empresa_id = " + id + "));",
				"delete from colaboradorresposta where areaorganizacional_id in (select id from areaorganizacional where empresa_id = " + id + ");",
				"delete from colaboradorquestionario where avaliacao_id in (select id from avaliacao where empresa_id = " + id + ");",
				"delete from colaboradorresposta where pergunta_id in (select id from pergunta where avaliacao_id in (select id from avaliacao where empresa_id = " + id + "));",
				"delete from pergunta where avaliacao_id in (select id from avaliacao where empresa_id = " + id + ");",
				"delete from mensagem where colaborador_id in (select id from colaborador where empresa_id = " + id + ");",
				"delete from mensagem where avaliacao_id in (select id from avaliacao where empresa_id = " + id + ");",
				...
				"delete from colaboradorocorrencia where ocorrencia_id in (select id from ocorrencia where empresa_id = " + id + ");",
				"delete from ocorrencia where empresa_id = " + id + ";",
				"delete from colaboradorocorrencia where providencia_id in (select id from providencia where empresa_id = " + id + ");",
				...
				"delete from colaboradorpresenca where colaboradorturma_id in (select id from colaboradorturma where colaborador_id in (select id from colaborador where empresa_id = " + id + "));",
				...
				"delete from resposta where pergunta_id in (select id from pergunta where questionario_id in (select id from questionario where empresa_id = " + id + "));",
				...
				"delete from configuracaoCampoExtraVisivelObrigadotorio where empresa_id = " + id + ";",
