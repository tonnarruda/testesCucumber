...
public interface HistoricoColaboradorDao extends GenericDao<HistoricoColaborador>
{
	...
	public Collection<HistoricoColaborador> findByCargoEstabelecimento(Date data, Long[] cargoIds, Long[] estabelecimentoIds, Date dataConsulta, Long[] areaOrganizacionalIds, Date dataAtualizacao);
