...
Funcionalidade: Cadastrar Candidato
  ...
  Cenário: Cadastro de Candidato
    ...
    E eu preencho "bairroNome" com "Nossa Senhora da Apresentação"
    ...
    E o campo "nome" deve conter "_Pedro do Teste"
    E eu preencho "nome" com "_Pedro do Teste 2"
    ...
    E eu clico no botão "Gravar"
    E eu devo ver "_Pedro do Teste 2"
