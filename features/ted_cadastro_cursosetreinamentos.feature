...
Funcionalidade: Cadastrar Curso
  ...
  Cenário: Cadastro de Curso
    ...
    E eu preencho o campo (JS) "prevIni" com "13/06/2011"
    E eu preencho o campo (JS) "prevFim" com "17/06/2011"
    E eu saio do campo "prevFim"
    E eu marco "13/06/2011 - segunda-feira"
    E eu marco "15/06/2011 - quarta-feira"
    E eu marco "17/06/2011 - sexta-feira"
    E eu clico no botão "Gravar"
    ...
    E eu devo ver "Período: 13/06/2011 a 17/06/2011"
