...
Funcionalidade: Cadastrar Cargos e Faixas
  ...
  Cenário: Cadastro de Cargos e Faixas
    ...
    E eu seleciono "Por índice" de "Tipo"
    E eu seleciono "Minimo" de "Índice"
    E eu preencho "Qtd." com "2"
    E eu saio do campo "Qtd."
    E eu clico no botão "Gravar"
